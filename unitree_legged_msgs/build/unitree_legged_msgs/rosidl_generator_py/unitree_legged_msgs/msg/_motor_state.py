...
class MotorState(metaclass=Metaclass_MotorState):
    ...
    def __init__(self, **kwargs):
        ...
        if 'reserve' not in kwargs:
            self.reserve = numpy.zeros(2, dtype=numpy.int32)
        else:
    ...
    def reserve(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'reserve' field must be a set or sequence with length 2 and each value of type 'int' and each integer in [-2147483648, 2147483647]"
