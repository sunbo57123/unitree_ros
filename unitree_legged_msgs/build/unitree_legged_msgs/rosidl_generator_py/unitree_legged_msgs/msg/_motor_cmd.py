...
class MotorCmd(metaclass=Metaclass_MotorCmd):
    ...
    def __init__(self, **kwargs):
        ...
        if 'reserve' not in kwargs:
            self.reserve = numpy.zeros(3, dtype=numpy.int32)
        else:
            self.reserve = numpy.array(kwargs.get('reserve'), dtype=numpy.int32)
    ...
    def reserve(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.int32, \
                "The 'reserve' numpy.ndarray() must have the dtype of 'numpy.int32'"
            assert value.size == 3, \
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'reserve' field must be a set or sequence with length 3 and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._reserve = numpy.array(value, dtype=numpy.int32)
