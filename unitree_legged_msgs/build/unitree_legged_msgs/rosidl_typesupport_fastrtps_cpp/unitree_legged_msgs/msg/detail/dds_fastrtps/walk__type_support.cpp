...
#include "unitree_legged_msgs/msg/detail/walk__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const unitree_legged_msgs::msg::HighCmd &,
...
cdr_serialize(
  const unitree_legged_msgs::msg::Walk & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unitree_legged_msgs::msg::Walk & ros_message)
{
  // Member: highcmd
  ...
  size_t current_alignment)
{
  ...
  // Member: highcmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        unitree_legged_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_HighCmd(
...
{
  auto typed_message =
    static_cast<const unitree_legged_msgs::msg::Walk *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unitree_legged_msgs::msg::Walk *>(
    untyped_ros_message);
...
{
  return &unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_Walk__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unitree_legged_msgs, msg, Walk)() {
  return &unitree_legged_msgs::msg::typesupport_fastrtps_cpp::_Walk__handle;
}
